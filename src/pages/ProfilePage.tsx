...
export default function ProfilePage() {
  ...
  return (
    ...
    >
      ...
      <div className="profile-photo relative z-10">
        ...
        <div
          ...
          style={{
            borderRadius: '0 0 20px 20px',
            background:
              'linear-gradient(to top, rgba(15,61,46,0.8) 0%, transparent 60%)',
          }}
        />
        <h1
          className="absolute"
      ...
      {/* Info Card */}
      <div
        className="info-card relative z-20"
        style={{
          background: '#FFFFFF',
          borderRadius: '20px',
          padding: '20px',
      ...
      >
        ...
        <div>
          ...
          >
            {selectedProvider.category} Service
          </span>
        ...
        <div className="flex flex-wrap gap-2" style={{ marginTop: '16px' }}>
          ...
          >
            <Clock size={12} />
            Responds in {selectedProvider.responseTime.replace('< ', '')}
          </span>
          <span
            style={{
              background: '#EDEADF',
      ...
      {/* Stats Row */}
      <div
        className="stats-row relative z-10 flex items-center"
        style={{
          marginTop: '20px',
          padding: '0 16px',
        }}
              ...
              <div className="flex gap-0.5">
                {Array.from({ length: 5 }).map((_, i) => (
                  <Star
                    ...
                    size={12}
                    color="#D4A843"
                    fill={i < review.rating ? '#D4A843' : 'none'}
                  />
                ))}
              </div>
              <p
      ...
      <div
        ...
        style={{
          padding: '12px 16px',
          paddingBottom: 'calc(12px + env(safe-area-inset-bottom, 0px) + 64px)',
          background: 'linear-gradient(to top, #F7F6F0 0%, transparent 100%)',
        }}
      >
        <button
